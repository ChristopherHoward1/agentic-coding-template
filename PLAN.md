...
- **Target execution environment declaration — ADOPTED as a conditional base convention.** Landed through issue #104; the authoritative convention and Software Engineer verification rule live in CLAUDE.md and AGENTS.md. Evidence is n=3 downstream projects defaulting generated code to macOS host assumptions, plus the in-repo #101/#102 precedent where a POSIX path-format assumption broke on Git Bash for Windows and was fixed provenance-first. Cost was not measured. This is the missing-declaration fix; it is **not** evidence for the Docker acceleration override above, which remains fenced, and does **not** resolve or justify work on the separate bash-3.2/toolchain-prerequisite observation.
